...
# Workflow function to process the entity
async def process_todo(data):
    # Example of modifying the entity state
    data['task'] = data['task'].upper()  # Change task to uppercase
...
async def create_todo(data: Todo):
    try:
        ...
        id = await entity_service.add_item(
            ...
            workflow=process_todo  # Adding the workflow function
        )
